...
for idx, alpha in enumerate(alpha_values):
    ...
    bin_edges = np.linspace(.45, 1.05, 15)  # 11 edges = 10 sections
...
plt.savefig("figures/concentration_bound.pdf", format="pdf", bbox_inches="tight")
print("Saved to figures/concentration_bound.pdf")
